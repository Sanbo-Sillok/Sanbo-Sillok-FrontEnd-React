...
export default function ImageSVG({ width, height, color }: SVGProps) {
  return (
    <svg fill="#000000" height={height || 24} width={width || 24} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 58 58">
      <g>
        <path
          className="dark:fill-base-200"
          fill={color || '#000000'}
