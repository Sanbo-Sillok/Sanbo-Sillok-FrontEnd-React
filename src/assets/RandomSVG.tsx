...
export default function RandomSVG({ width, height, color }: SVGProps) {
  return (
    <svg width={width || 24} height={height || 24} xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd">
      <path
        stroke={color || '#FFFFFF'}
        fill={color || '#FFFFFF'}
        strokeWidth={0.4}
